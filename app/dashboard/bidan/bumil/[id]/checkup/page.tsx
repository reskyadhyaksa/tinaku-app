...
export default function BidanBumilCheckupPage() {
  ...
  // Tab selector state
  const [activeTab, setActiveTab] = useState<'midwife' | 'doctor'>('midwife');
  ...
  return (
    <div className="min-h-screen bg-pink-50 p-4 md:p-8 font-sans pb-24">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {/* Header & Back Action */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 md:px-8 md:py-6 rounded-3xl shadow-sm border border-pink-100">
          <div className="flex items-center gap-4">
            <button 
              onClick={() => router.push('/dashboard/bidan/bumil')} 
              className="h-12 w-12 bg-white border border-gray-100 rounded-2xl flex items-center justify-center hover:bg-gray-50 transition-colors shadow-sm shrink-0"
            >
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-lg md:text-2xl font-black text-gray-900">Pemeriksaan Medis KIA</h1>
              </div>
              <p className="text-sm text-gray-500 font-medium mt-0.5">
                Ibu Hamil: <strong className="text-gray-900">{bumil?.name}</strong> • NIK: <span className="font-mono text-xs">{bumil?.nik || '-'}</span>
              </p>
            </div>
          </div>
          <div className="flex items-center gap-3 bg-pink-50/50 px-4 py-3 rounded-2xl border border-pink-100 shrink-0">
            <div className="h-10 w-10 bg-pink-500 rounded-xl flex items-center justify-center text-white shrink-0">
              <Stethoscope className="w-5 h-5" />
            </div>
            <div>
              <p className="text-[9px] uppercase font-black text-gray-400">Usia Ibu Hamil</p>
              <p className="text-sm font-bold text-gray-800">{bumil?.age} Tahun</p>
            </div>
          </div>
        </div>

        {/* Tab Selection Navigation */}
        <div className="flex bg-white p-2 rounded-3xl shadow-sm border border-pink-100/55 max-w-md">
          <button
            onClick={() => setActiveTab('midwife')}
            className={`flex-1 py-3 px-4 rounded-2xl text-xs font-black uppercase tracking-wider transition-all duration-200 ${
              activeTab === 'midwife' 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          {/* TAB 1: MIDWIFE CHECKUP */}
          {activeTab === 'midwife' && (
            <>
              {/* Left Side: Medical Entry Form */}
              <div className="lg:col-span-5 bg-white p-6 md:p-8 rounded-[36px] shadow-sm border border-pink-100 space-y-6">
                <div className="flex items-center gap-3 pb-4 border-b border-gray-50">
                  <div className="h-10 w-10 bg-gradient-to-br from-pink-400 to-pink-500 rounded-xl flex items-center justify-center text-white shadow-md shadow-pink-100">
                    <Plus className="w-5 h-5" />
                  </div>
                  <div>
                    <h2 className="text-lg font-black text-gray-900">Catat Pemeriksaan Bidan</h2>
                    <p className="text-xs text-gray-400 font-bold uppercase tracking-wider">Parameter Klinis Kebidanan</p>
                  </div>
                </div>
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="relative rounded-2xl bg-white border border-gray-100 flex items-center shadow-sm focus-within:border-pink-300 transition-all">
                          ...
                          <input 
                            ...
                            className="w-full pl-2 pr-16 py-3.5 rounded-2xl text-xs font-black text-gray-750 outline-none border-none focus:ring-0 bg-transparent transition-all"
                          />
              ...
              {/* Right Side: Checkup History Timeline */}
              <div className="lg:col-span-7 bg-white p-6 md:p-8 rounded-[36px] shadow-sm border border-pink-100 space-y-6">
                <div className="flex items-center justify-between pb-4 border-b border-gray-50">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-lg font-black text-gray-900">Histori Pemeriksaan Bidan</h2>
                      <p className="text-xs text-gray-400 font-bold uppercase tracking-wider">Rekam Medis KIA Berkala</p>
                    </div>
                  </div>
                  <span className="px-3 py-1 bg-gray-50 rounded-full border border-gray-100 text-xs font-bold text-gray-500">
                    {checkups.length} Catatan
                  </span>
                </div>
                      ...
                      <div key={checkup.id} className="bg-white hover:bg-gray-50/50 p-5 rounded-[28px] border border-gray-100 transition-all flex flex-col sm:flex-row justify-between items-start gap-4 shadow-sm">
                        <div className="space-y-4 w-full">
                          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-gray-50 pb-3">
                            ...
                            <span className="text-xs font-bold text-gray-400 bg-gray-50 px-3 py-1 rounded-full border border-gray-100/50">🗓️ {new Date(checkup.checkup_date).toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' })}</span>
                          </div>
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                            ...
                            <div className="p-3 bg-amber-50/30 rounded-2xl border border-amber-100/20">
                              ...
                              <span className="text-sm font-extrabold text-gray-800 block truncate mt-0.5">{checkup.tfu} cm</span>
          ...
          {/* TAB 2: DOCTOR / USG EXAM */}
          {activeTab === 'doctor' && (
            <>
              {/* Left Side: Doctor Entry Form */}
              <div className="lg:col-span-6 bg-white p-6 md:p-8 rounded-[36px] shadow-sm border border-pink-100 space-y-6">
                <div className="flex items-center justify-between pb-4 border-b border-gray-50">
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-10 bg-pink-500 rounded-xl flex items-center justify-center text-white shadow-md">
                      <Stethoscope className="w-5 h-5" />
                    </div>
                    <div>
                      <h2 className="text-lg font-black text-gray-900">Catat USG Trimester I</h2>
                      <p className="text-xs text-gray-450 font-bold uppercase tracking-wider">Formulir Pemeriksaan Dokter</p>
                    </div>
                  </div>
                  <span className="px-3 py-1 bg-pink-550 text-white rounded-full text-[10px] font-black uppercase">DIISI OLEH DOKTER</span>
                </div>
                ...
                <form onSubmit={handleSubmitDocCheckup} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <select 
                      ...
                      onChange={handleDocInputChange}
                      className="w-full px-4 py-3.5 border border-gray-100 bg-gray-50 focus:bg-white rounded-2xl text-xs font-bold text-gray-700 focus:ring-2 focus:ring-pink-100 outline-none transition-all"
                    >
                  ...
                  <div className="space-y-4 p-5 bg-pink-50/10 rounded-3xl border border-pink-100/20">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <select 
                          name="keteraturan_haid" value={docForm.keteraturan_haid} onChange={handleDocInputChange}
                          className="w-full px-4 py-2.5 border border-gray-100 bg-white rounded-2xl text-xs font-bold text-gray-700 outline-none"
                        >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 bg-pink-50/5 p-5 rounded-3xl border border-pink-150/15">
                    ...
                    <div className="space-y-3 bg-white p-4 rounded-2xl border border-gray-100 shadow-sm">
                      ...
                      <div className="space-y-2">
                        ...
                        <select name="jumlah_gs" value={docForm.jumlah_gs} onChange={handleDocInputChange} className="w-full px-3 py-2 border border-gray-50 bg-gray-50 rounded-xl text-xs font-bold text-gray-700">
                    ...
                    <div className="space-y-3 bg-white p-4 rounded-2xl border border-gray-100 shadow-sm">
                      ...
                      <div className="space-y-2">
                        ...
                        <select name="jumlah_bayi" value={docForm.jumlah_bayi} onChange={handleDocInputChange} className="w-full px-3 py-2 border border-gray-50 bg-gray-50 rounded-xl text-xs font-bold text-gray-700">
                          <option value="Tunggal">Tunggal</option>
                          <option value="Kembar">Kembar</option>
                        </select>
                      </div>
                  ...
                  <div className="space-y-4 p-5 bg-gray-50/50 rounded-3xl border border-gray-100">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-2 bg-white p-3 rounded-2xl border border-gray-100">
                        <label className="text-[9px] font-black text-gray-450 uppercase block tracking-wider">Letak Kehamilan</label>
                        <select name="letak_kehamilan" value={docForm.letak_kehamilan} onChange={handleDocInputChange} className="w-full py-1 px-2 border-none bg-gray-50 rounded-lg text-xs font-bold text-gray-700">
                      ...
                      <div className="space-y-2 bg-white p-3 rounded-2xl border border-gray-100">
                        <label className="text-[9px] font-black text-gray-450 uppercase block tracking-wider">Denyut / Pulsasi Jantung</label>
                        <select name="pulsasi_jantung" value={docForm.pulsasi_jantung} onChange={handleDocInputChange} className="w-full py-1 px-2 border-none bg-gray-50 rounded-lg text-xs font-bold text-gray-700">
                    ...
                    <div className="space-y-3 bg-white p-4 rounded-2xl border border-gray-100">
                      <div className="flex items-center justify-between">
                        <label className="text-[9px] font-black text-gray-450 uppercase block tracking-wider">Kecurigaan Temuan Abnormal</label>
              ...
              {/* Right Side: Doctor USG History Timeline */}
              <div className="lg:col-span-6 bg-white p-6 md:p-8 rounded-[36px] shadow-sm border border-pink-100 space-y-6">
                <div className="flex items-center justify-between pb-4 border-b border-gray-50">
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-10 bg-indigo-50 text-indigo-500 rounded-xl flex items-center justify-center">
                    ...
                    <div>
                      <h2 className="text-lg font-black text-gray-900">Histori USG & Hasil Dokter</h2>
                      <p className="text-xs text-gray-400 font-bold uppercase tracking-wider">Rekam USG Trimester I</p>
                    </div>
                  </div>
                  <span className="px-3 py-1 bg-gray-50 rounded-full border border-gray-100 text-xs font-bold text-gray-500">
                    {doctorCheckups.length} Catatan
                  </span>
                </div>
                    ...
                    {doctorCheckups.slice().reverse().map((dc) => (
                      <div key={dc.id} className="bg-white hover:bg-gray-50/50 p-5 rounded-[28px] border border-gray-100 transition-all flex flex-col justify-between gap-4 shadow-sm">
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-gray-50 pb-3">
                          ...
                          <span className="text-xs font-bold text-gray-400 bg-gray-50 px-3 py-1 rounded-full border border-gray-100/50">
                            🗓️ {new Date(dc.checkup_date).toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' })}
                          </span>
                        </div>
                        ...
                        <div className="flex justify-between items-center bg-pink-50/10 p-3 rounded-2xl border border-pink-100/20 text-xs font-bold">
                          ...
                          <span className={`px-2 py-0.5 rounded-full text-[9px] font-black uppercase ${dc.konsep === 'Normal' ? 'bg-green-50 text-green-600' : 'bg-red-50 text-red-600'}`}>
                        ...
                        <div className="grid grid-cols-3 gap-2 text-[10px] font-black uppercase text-center">
                          <span className="bg-blue-50 text-blue-700 py-1.5 px-2 rounded-xl border border-blue-100/50">Letak: {dc.letak_kehamilan}</span>
                          <span className="bg-emerald-50 text-emerald-700 py-1.5 px-2 rounded-xl border border-emerald-100/50">Jantung: {dc.pulsasi_jantung}</span>
                          <span className={`py-1.5 px-2 rounded-xl border ${dc.kecurigaan_abnormal === 'Ya' ? 'bg-red-50 text-red-700 border-red-200' : 'bg-green-50 text-green-700 border-green-200'}`}>Abnormal: {dc.kecurigaan_abnormal}</span>
                        </div>

                        {dc.kecurigaan_abnormal === 'Ya' && dc.kecurigaan_abnormal_detail && (
                          <div className="bg-red-50/30 p-3 rounded-2xl border border-red-150/15 text-xs text-red-700 font-bold">
                            ⚠️ Detail Abnormal: {dc.kecurigaan_abnormal_detail}
                          </div>
                        )}
